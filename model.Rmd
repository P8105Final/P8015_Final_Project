...
```{r}
autoplot(murder_count_time_series)+
  ylab("Shoots") +
...
```{r}
ggseasonplot(murder_count_time_series, year.labels=TRUE, year.labels.left=TRUE) +
  ylab("Shoots") +
