...
This is new york census data in 2010 for each age group from NYC open data which was used as population reference.
...
vic_age_data = 
  ...
  mutate(
    prop = (incident_case/age_clean_census$population * 1000000 )/15) %>%
