...
#  Kruskal-Wallis analysis: Which boro is most dangerous?
...
percinct_pop = percinct_pop %>% 
  select(precinct_2020, P0010001)

data1 = data %>%
  count(boro, precinct) %>%
  left_join(percinct_pop, 
            by = c("precinct" = "precinct_2020"))

data1$shoot_per_thousand = data1$n / data1$P0010001 * 1000
...
1. Where do the shooting most happens? (The last bar is not applicable) From the plot we know that first 3 places are apartment and houses, and of the public area, the first 3 are grocery stor, bar / night club and comercial buildings.
...
2. When do most of the shooting happens?
