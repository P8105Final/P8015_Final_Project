...
At the very beginning, let's have a overall glance at the shooting incidence and focusing on the most serious issue, which is the amount of death on shooting incident from **2010 to 2020** in New York City.
...
Murdered shooting incidence is much less than survived shooting incidence.Both types of the shooting incidence were decreasing gradually from 2010 to 2019. However, there is a huge dramatically increase in 2020. We suspect it may be due to the outbreak of COVID-19 which led to a raise in unemployment and panic.
...
**Male** victims are the majority and female victims have a very small proportion among the total victims in nyc across 2010 to 2020.
...
The proportion of age group under 18 and 45-64 have been keeping consistently low across 2010 to 2020, and there are nearly zero incidence for age group over 65.
From 2010-2014, age group 18-24 and age group 25-44 have the highest proportion among the shooting incident. But since 2015, the amount of group 18-24 victims have been decreasing rapidly and become the second highest group among the total shooting incident. 18-24 usually is the age to graduate from high school and enter to college, this decrease may referring to some educational policy from 2015.
...
Both of the perpetrator and victims might be influenced by the education level. Therefore, we visualize the perpetrator's age from 2006 to 2020 and present a percentage of each educational level from 2010 to 2020. The association between the educational level and perpetrator's age group.
