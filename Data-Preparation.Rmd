...
4. Population in each Police Precinct Data
...
4. Population in each Police Precinct 
...
We used the `unemployment rate`, `educational attainment`, and `police precint` data to further explore and analyze the findings that we obtained from our main `shooting incident` data. They are used in both the descriptive and statistical analysis in our project. `unemployment rate` has the monthly unemployment rate of NYC from 2010 to 2020. `educational attainment` has the percentage of adults(aged 18 and above) who received high school or higher education in each borough.Finally,`police precinct` has the total population of each police precinct in NYC. 
