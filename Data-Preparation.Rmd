...
```{r}
education_df = read_csv("data/education/educational_attainment.csv") %>% mutate(year = as.character(year))
```
...
combined_df = left_join(data_unemployed_df,education_df, by = c("year","boro")) %>% view()
```
